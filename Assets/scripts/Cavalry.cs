...
public class Cavalry : MonoBehaviour
{
    ...
    public float checkDistance = 1.8f;
    ...
    void Start()
    {
        ...
        {
            myDamage = GameManager.Instance.GetCavalryDamage();
            maxHealth = EconomyConfig.GetUnitMaxHealth(180, GameManager.Instance.cavalryLevel);
            attackRate = EconomyConfig.GetUnitAttackRate(1.2f, GameManager.Instance.cavalryLevel);
        }
        else { myDamage = 25; maxHealth = 180; attackRate = 1.2f; }
    ...
    void Update()
    {
        ...
        if (GameManager.Instance != null) myDamage = GameManager.Instance.GetCavalryDamage();
    ...
    void Die()
    {
        ...
        {
            GameManager.Instance.OnUnitDeath(gameObject, "Cavalry"); 
        }
